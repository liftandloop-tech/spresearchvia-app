  ...
  Widget build(BuildContext context) {
    ...
    switch (buttonType) {
      case ButtonType.green:
        backgroundColor = onTap != null ? AppTheme.buttonGreen : AppTheme.buttonDisabled;
        textColor = AppTheme.textWhite;
        iconColor = AppTheme.textWhite;
        borderColor = null;
        break;
      case ButtonType.blue:
        backgroundColor = onTap != null ? AppTheme.buttonBlue : AppTheme.buttonDisabled;
        textColor = AppTheme.textWhite;
        iconColor = AppTheme.textWhite;
        borderColor = null;
        break;
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: borderColor != null ? Border.all(color: borderColor, width: AppDimensions.borderMedium) : null,
